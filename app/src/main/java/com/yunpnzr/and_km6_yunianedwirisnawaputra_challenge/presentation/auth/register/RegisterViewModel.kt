...
class RegisterViewModel(private val repository: UserRepository): ViewModel() {
    fun doRegister(name: String, email: String, password: String, phoneNumber: String): LiveData<ResultWrapper<Boolean>> {
        return repository.doRegister(name, email, password, phoneNumber).asLiveData(Dispatchers.IO)
    }
